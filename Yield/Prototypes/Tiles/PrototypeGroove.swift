...
struct PrototypeGroove: PrototypeTile {
    ...
    var polygons: [Euclid.Polygon] {
        ...
        case .mantle:
            ...
            let biscuit = Mesh(GrooveBiscuit(ordinal: ordinal, material: material, volume: volume, style: style, inset: material.insetThrone).polygons)
        ...
        default:
            ...
            let biscuitThrone = Mesh(GrooveBiscuit(ordinal: ordinal, material: material, volume: .throne, style: style, inset: material.insetThrone).polygons)
            let biscuitCrown = Mesh(GrooveBiscuit(ordinal: ordinal, material: material, volume: .crown, style: style, inset: material.insetCrown).polygons)
